...
export const SUPPLY_LIST: Supply = {
  ...
  bsc: {
    token: {
      ...
      KLAY: { address: "0xD518a4Aa913f4FCF6AF70c543220717f582939e6", icon: KlaytnIcon, apy: 2.5, balance: 70 }
    },
    farm: {},
    "lending protocols": {},
    "liquid staking": {
  ...
  polygon: {
    token: {
      ...
      KLAY: { address: "0x7b2493189F2484Ca03f70081fC88ee151A452832", icon: KlaytnIcon, apy: 3, balance: 70 }
    }
    ,
    farm: {},
    "lending protocols": {},
